...
Esta carpeta contiene las evidencias utilizadas para verificar la
implementación del proyecto integrador de streaming.

## Pruebas y calidad

- `pytest.txt`: resultado de la suite completa de pruebas.
- `ruff.txt`: resultado del análisis estático.

## Infraestructura

- `kafka-topics.txt`: descripción de los topics Kafka.
